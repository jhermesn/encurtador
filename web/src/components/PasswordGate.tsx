...
export default function PasswordGate() {
  ...
  if (gateState === 'checking') {
    return (
      <>
        <Helmet>
          <title>Encurtador — Verificando link</title>
          <meta
            name="description"
            content="Verificando se este link encurtado está protegido por senha ou ainda está disponível."
          />
  ...
  return (
    <>
      <Helmet>
        <title>Encurtador — Senha necessária</title>
        <meta
          name="description"
          content="Este link está protegido por senha. Digite a senha correta para continuar para o destino."
        />
        <meta name="robots" content="noindex, nofollow" />
      </Helmet>
      <div className="flex flex-1 items-center justify-center px-4 py-12">
