...
export default function ManagePage() {
  ...
  if (expired) {
    return (
      <>
        <Helmet>
          <title>Encurtador — URL expirada</title>
          <meta
            name="description"
            content="Esta URL encurtada foi expirada manualmente e não está mais acessível."
          />
  ...
  return (
    <>
      <Helmet>
        <title>Encurtador — Gerenciar URL</title>
        <meta
          name="description"
          content="Página de gerenciamento de uma URL encurtada. Use o token de gerenciamento para expirar o link quando quiser."
        />
        <meta name="robots" content="noindex, nofollow" />
      </Helmet>
      <div className="flex flex-1 items-center justify-center px-4 py-12">
